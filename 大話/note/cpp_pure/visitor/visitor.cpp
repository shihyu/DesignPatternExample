...
class Action {
public:
    virtual void getManReflection() = 0;
    virtual void getWomanReaction() = 0;
};
...
public:
    virtual void getManReflection();

    virtual void getWomanReaction();
