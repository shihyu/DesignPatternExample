...
QRCodeValidState* QRCodeValidState_construct(void* addr,
        QRCodeStateMachine* stateMachine)
{
    ...
    AbstractQRCodeState_construct(&qrcodeValidState->abstractQRCodeState,
                                  stateMachine);
...
{
    QRCodeValidState* qrcodeValidState = container_of(iqrcodeState,
                                         QRCodeValidState, iqrcodeState);
    qrcodeValidState->stateMachine->setState(qrcodeValidState->stateMachine,
            AUTHORIZING);
