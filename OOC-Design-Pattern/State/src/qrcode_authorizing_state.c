...
QRCodeAuthorizingState* QRCodeAuthorizingState_construct(void* addr,
        QRCodeStateMachine* stateMachine)
{
    ...
    AbstractQRCodeState_construct(&qrcodeAuthorizingState->abstractQRCodeState,
                                  stateMachine);
...
void QRCodeAuthorizingState_destruct(QRCodeAuthorizingState*
                                     qrcodeAuthorizingState)
{
...
{
    QRCodeAuthorizingState* qrcodeAuthorizingState = container_of(iqrcodeState,
            QRCodeAuthorizingState, iqrcodeState);
    qrcodeAuthorizingState->stateMachine->setState(
        qrcodeAuthorizingState->stateMachine, AUTHORIZED);
...
void QRCodeAuthorizingState_cancel(IQRCodeState* iqrcodeState)
{
    QRCodeAuthorizingState* qrcodeAuthorizingState = container_of(iqrcodeState,
            QRCodeAuthorizingState, iqrcodeState);
    qrcodeAuthorizingState->stateMachine->setState(
        qrcodeAuthorizingState->stateMachine, NOQRCODE);
