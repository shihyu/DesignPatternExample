...
QRCodeStateMachine* QRCodeStateMachine_construct(void* addr)
{
    ...
    qrcodeStateMachine->noQRCodeState = &new(NoQRCodeState,
                                        qrcodeStateMachine)->iqrcodeState;
    qrcodeStateMachine->qrcodeValidState = &new(QRCodeValidState,
                                           qrcodeStateMachine)->iqrcodeState;
    qrcodeStateMachine->qrcodeAuthorizingState = &new(QRCodeAuthorizingState,
            qrcodeStateMachine)->iqrcodeState;
    qrcodeStateMachine->qrcodeAuthorizedState = &new(QRCodeAuthorizedState,
            qrcodeStateMachine)->iqrcodeState;
...
{
    delete(NoQRCodeState, container_of(stateMachine->noQRCodeState, NoQRCodeState,
                                       iqrcodeState));
    delete(QRCodeValidState, container_of(stateMachine->qrcodeValidState,
                                          QRCodeValidState, iqrcodeState));
    delete(QRCodeAuthorizingState,
           container_of(stateMachine->qrcodeAuthorizingState, QRCodeAuthorizingState,
                        iqrcodeState));
    delete(QRCodeAuthorizedState, container_of(stateMachine->qrcodeAuthorizedState,
            QRCodeAuthorizedState, iqrcodeState));
}
...
{
    QRCodeStateMachine* stateMachine = container_of(iqrcodeState,
                                       QRCodeStateMachine, iqrcodeState);
