...
QRCodeAuthorizedState* QRCodeAuthorizedState_construct(void* addr,
        QRCodeStateMachine* stateMachine)
{
    ...
    AbstractQRCodeState_construct(&qrcodeAuthorizedState->abstractQRCodeState,
                                  stateMachine);
...
void QRCodeAuthorizedState_destruct(QRCodeAuthorizedState*
                                    qrcodeAuthorizedState)
{
...
{
    QRCodeAuthorizedState* qrcodeAuthorizedState = container_of(iqrcodeState,
            QRCodeAuthorizedState, iqrcodeState);
    qrcodeAuthorizedState->stateMachine->setState(
        qrcodeAuthorizedState->stateMachine, NOQRCODE);
