...
NoQRCodeState* NoQRCodeState_construct(void* addr,
                                       QRCodeStateMachine* stateMachine)
{
    ...
    AbstractQRCodeState_construct(&noqrcodeState->abstractQRCodeState,
                                  stateMachine);
...
{
    NoQRCodeState* noqrcodeState = container_of(iqrcodeState, NoQRCodeState,
                                   iqrcodeState);
