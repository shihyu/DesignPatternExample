...
static IPermission* PermissionFactory_createPermission(PermissionFactory*,
        PermissionType);
...
PermissionFactory* PermissionFactory_construct(void* addr)
{
    ...
    permissionFactory->readWritePermission = &new(ReadWritePermission,
            permissionFactory->readPermission,
            permissionFactory->writePermission)->ipermission;
...
IPermission* PermissionFactory_createPermission(PermissionFactory*
        permissionFactory, PermissionType permissionType)
{
