...
void AbstractManager_construct(void* addr)
{
    ...
    abstractManager->handleAskForLeaveRequest =
        AbstractManager_handleAskForLeaveRequest;
...
int AbstractManager_handleAskForLeaveRequest(IManager* imanager, char* name,
        int days)
{
...
int AbstractManager_handleRaisesRequest(IManager* imanager, char* name,
                                        int money)
{
    fprintf(stderr, "Not implemented!\n");
    abort();
...
void AbstractManager_setManager(AbstractManager* abstractManager,
                                IManager* manager)
{
