...
int main()
{
    ...
    FindPwdMessage* smsFindPwdMessage = new(FindPwdMessage,
                                            &smsSender->imessageSender);
    FindPwdMessage* emailFindPwdMessage = new(FindPwdMessage,
            &emailSender->imessageSender);
    SignupMessage* smsSignupMessage = new(SignupMessage,
                                          &smsSender->imessageSender);
    SignupMessage* emailSignupMessage = new(SignupMessage,
                                            &emailSender->imessageSender);

    smsFindPwdMessage->setContent(&smsFindPwdMessage->abstractMessage,
                                  "findpwd message");
    emailFindPwdMessage->setContent(&emailFindPwdMessage->abstractMessage,
                                    "findpwd message");
    smsSignupMessage->setContent(&smsSignupMessage->abstractMessage,
                                 "signup message");
    emailSignupMessage->setContent(&emailSignupMessage->abstractMessage,
                                   "signup message");
