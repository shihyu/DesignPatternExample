...
static void CalculatorMementoManager_setMemento(CalculatorMementoManager*,
        IMemento*);
...
void CalculatorMementoManager_destruct(CalculatorMementoManager*
                                       calculatorMementoManager)
{
    // TODO delete memento
}

void CalculatorMementoManager_setMemento(CalculatorMementoManager*
        calculatorMementoManager, IMemento* memento)
{
    // TODO delete memento
    calculatorMementoManager->memento = memento;
}

IMemento* CalculatorMementoManager_getMemento(CalculatorMementoManager*
        calculatorMementoManager)
{
