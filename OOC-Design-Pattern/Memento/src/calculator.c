...
static CalculatorMemento* CalculatorMemento_construct(void* addr,
        Calculator* calculator);
...
{
    CalculatorMemento* calculatorMemento = container_of(memento, CalculatorMemento,
                                           imemento);
    calculator->result = CalculatorMemento_getMemento(calculatorMemento)->result;
}

CalculatorMemento* CalculatorMemento_construct(void* addr,
        Calculator* calculator)
{
    if (addr == NULL) {
        return NULL;
