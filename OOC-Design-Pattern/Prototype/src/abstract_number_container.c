...
static void AbstractNumberContainer_foreach(AbstractNumberContainer*,
        void (*)(int));
...
void AbstractNumberContainer_destruct(AbstractNumberContainer*
                                      abstractNumberContainer)
{
    free(abstractNumberContainer->container);
}

void AbstractNumberContainer_addNumber(AbstractNumberContainer*
                                       abstractNumberContainer, int number)
{
    abstractNumberContainer->container[abstractNumberContainer->idx++] =
        abstractNumberContainer->align(abstractNumberContainer, number);
}

void AbstractNumberContainer_foreach(AbstractNumberContainer*
                                     abstractNumberContainer, void (*callback)(int))
{
    int i;
...
int AbstractNumberContainer_align(AbstractNumberContainer*
                                  abstractNumberContainer, int number)
{
