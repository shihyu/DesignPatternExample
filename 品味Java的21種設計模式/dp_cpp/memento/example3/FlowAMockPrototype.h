		...
		namespace dp
		{
			namespace memento
			{
				namespace example3
				{
					...
					/// 
					class FlowAMockPrototype : public Cloneable
					{
					///	
					...
					///	 
					public:
						FlowAMockPrototype(std::string flowName);
					///	
					...
					///	 
					private:
						class MementoImplPrototype : public FlowAMockMemento
						{
						private:
							FlowAMockPrototype *flowAMock;

						public:
							MementoImplPrototype(FlowAMockPrototype *f);

							virtual FlowAMockPrototype *getFlowAMock();
						};
					};
