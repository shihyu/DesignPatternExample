...
namespace HeadFirstDesignPatterns {
    namespace Builder {
        ...
        private:
            Event _vacation;
        private:
            EventComponent* _currentDay;
        private:
            EventComponent* _currentEvent;
        ...
        public:
            void addHotel(const std::string& hotel) {
                assert(_currentDay);
        ...
        public:
            void addTickets(const std::string& event) {
